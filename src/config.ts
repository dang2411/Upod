...
export const HOST_API = import.meta.env.REACT_APP_HOST_API_KEY || 'https://upod-api.azurewebsites.net/';
...
export const PATH_AFTER_LOGIN = '/dashboard/home'; // as '/dashboard/app'
